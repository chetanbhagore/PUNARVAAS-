...
def generate_relocation_plan(
    ...
    for hab in sorted_habs:
        ...
        while remaining_to_allocate > 0:
            ...
            allocations.append({
                ...
                "allocated_count": alloc_headcount,
                "site_id": best_site["site_id"],
                "safe_site_id": best_site["site_id"],
                "site_name": best_site["name"],
                "safe_site_name": best_site["name"],
    ...
    for s in sites_state.values():
        ...
        ranked_sites.append({
            ...
            "capacity_persons": s.get("capacity_persons", usable),
